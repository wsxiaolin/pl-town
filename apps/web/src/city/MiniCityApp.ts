...
function setupMultiplayerUI() {
  ...
  document.getElementById('phoneOpenWorks')?.addEventListener('click',()=>{setPhoneOpen(false);openWorksPanel('all');},{signal:eventController.signal});
  document.querySelectorAll('[data-pl-social]').forEach(button=>button.addEventListener('click',()=>loadPhoneSocial(button.dataset.plSocial),{signal:eventController.signal}));
