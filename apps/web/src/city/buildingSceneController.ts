...
import type { BuiltBuilding, BuildingDefinition, ShapeBuilder } from '../rendering/buildingMeshFactory';
...
export function createBuildingSceneController(options: {
  ...
  addFacade: (group: THREE.Object3D, texKey: string, width: number, height: number, y: number, zOffset: number, rotY?: number) => THREE.Mesh | null;
