...
const WEATHER_TEXTURE_VARIANTS: Record<string, Partial<Record<Weather, string>>> = {
  asphalt: { clear: 'road_asphalt_charcoal', rain: 'road_asphalt_wet', snow: 'road_snow_fresh' },
  road: { clear: 'road_concrete_paver', rain: 'road_concrete_wet', snow: 'road_snow_compact' },
  pavement: { clear: 'road_concrete_paver', rain: 'road_concrete_wet', snow: 'road_snow_compact' },
  residence_cream: { clear: 'residence_cream', rain: 'residence_cream_wet', snow: 'residence_cream_snow' },
  facade_residence_cream: { clear: 'residence_cream', rain: 'residence_cream_wet', snow: 'residence_cream_snow' },
  ...
  residence_tile: { clear: 'residence_green_roof', rain: 'residence_green_roof_wet', snow: 'residence_green_roof_snow' },
  residence_shingle: { clear: 'residence_slate_roof', rain: 'residence_slate_roof_wet', snow: 'residence_slate_roof_snow' },
  rooftile: { clear: 'residence_terracotta_roof', rain: 'residence_terracotta_roof_wet', snow: 'residence_terracotta_roof_snow' },
