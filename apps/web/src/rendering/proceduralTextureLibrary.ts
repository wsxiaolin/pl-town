...
export function createProceduralTextureLibrary(
  ...
  function initTextures() {
    ...
    _canvas('facade_screen',512,(ctx,s)=>{ctx.fillStyle='#EAE9E6';ctx.fillRect(0,0,s,s);_cornice(ctx,0,'#D8D7D2');_cornice(ctx,s-12,'#D8D7D2');ctx.fillStyle='#2A2A30';ctx.fillRect(30,30,s-60,s-60);const gr=ctx.createLinearGradient(0,30,0,s-30);gr.addColorStop(0,'#1A3A6E');gr.addColorStop(0.5,'#2A5FA8');gr.addColorStop(1,'#1A3A6E');ctx.fillStyle=gr;ctx.fillRect(35,35,s-70,s-70);ctx.fillStyle='rgba(200,220,250,0.6)';ctx.fillRect(60,60,s-120,4);ctx.fillRect(60,75,s-150,3);ctx.font='bold 11px sans-serif';ctx.textAlign='center';ctx.fillStyle='rgba(255,255,255,0.8)';ctx.fillText('never goona give you up',s/2,s/2-12);ctx.fillText('never gonna let you down',s/2,s/2+10);ctx.fillStyle='#D0CFCC';ctx.fillRect(s/2-2,0,4,30);_noise(ctx,s,0.02);});
